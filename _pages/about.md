...
📚 I'm a Junior at the Texas Academy of Mathematics and Science (TAMS), studying Computer Science.

👀 I'm interested in Computer Vision (specifically view and image synthesis), and Multimodal Learning (Video-Text tasks).

🎶 I also play the Cello!

Selected Projects
===
1️⃣ **UCF-101 Transformer Model:** Transformer-Based Encoder for Action Recognition Classification on 101 different actions (Code not published yet). 

2️⃣ **KMNIST DC-GAN:** Custom Deep Convolutional Generative Generative Adversarial Network for Kuzushiji Letter/Writing Form Generation ([Code](https://github.com/dyl-joseph/KMNIST-DC-GAN)).
